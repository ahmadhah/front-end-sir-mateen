...
export default function New() {
    const [infectiontracking, setInfectionTracking] = useState(data)
            ...
            <div className='card mb-5 col-mb-10' id='kt_content'>
                <div className='post d-flex flex-column-fluid' id='kt_post'>
                    <div id='kt_content_container' className='container-xxl'>
                        <div className='card'>
                            <h2 className='mt-6 mb-0'>Select Program For Infection Tracking</h2>
                            ...
                            <div className='card-body table-responsive pt-0'>
                                ...
                                >
                                    ...
                                    <tbody className='fw-bold text-gray-600'>
                                        {infectiontracking.map((infectiontracking) => (
                                            <Fragment>
                                                <ReadOnlyRow
