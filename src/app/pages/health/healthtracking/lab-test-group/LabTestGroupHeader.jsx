    ...
    return (
        <div>
            ...
            <div className='card mb-5 mb-xl-10'>
                ...
                <p className='text-gray-800 fs-2 fw-bolder'>Lab Test Group</p>
                        ...
                        <ul className='nav nav-stretch nav-line-tabs border-transparent fs-6 flex-nowrap'>
                            ...
                            <li className='nav-item'>
                                <Link
                                    className={
                                        `nav-link text-active-primary me-4` +
                                        (location.pathname === '/healthtracking/lab-test-group/list' && 'active')
                                    }
                                    to='/healthtracking/lab-test-group/list'
                                >
                                    List
                                </Link>
                            </li>
...
export default LabTestGroupHeader