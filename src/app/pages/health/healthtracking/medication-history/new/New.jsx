...
export default function New() {
    const [medicationhistory, setMedicatioHistory] = useState(data)
            ...
            <div className='card mb-5 col-mb-10' id='kt_content'>
                <div className='post d-flex flex-column-fluid' id='kt_post'>
                    <div id='kt_content_container' className='container-xxl'>
                        <div className='card'>
                            <h2 className='mt-6 mb-0'>Select Individual For Medication History</h2>
                                ...
                                >
                                    <thead>
                                        <tr className='text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0'>
                                            ...
                                            <th className="min-w-200px">Individual ID</th>
