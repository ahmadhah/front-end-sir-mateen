...
export default function List() {
    const [medicationadministrationrecords, setMedicationAdministrationRecord] = useState(data)
                            ...
                            <div className='card-body table-responsive pt-0'>
                                ...
                                >
                                    ...
                                    <tbody className='fw-bold text-gray-600'>
                                        {medicationadministrationrecords.map((medicationadministrationrecord) => (
                                            <Fragment>
                                                <ReadOnlyRow
