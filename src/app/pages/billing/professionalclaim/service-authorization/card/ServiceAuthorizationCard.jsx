...
function ServiceAuthorizationCard() {
  return (
    <>
      ...
      <div className="card card-stretch-75 mb-xl-8">
        ...
        <div className="card-header border-0 bg-warning py-5">
          <h3 className="card-title fw-bolder text-white">Service Authorization</h3>
        </div>
        {/*end::Header*/}
        {/*begin::Body*/}
            ...
            <div className="row g-0 ">
              ...
              <div className="col-4">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    ...
                    <Link to="/professionalclaim/service-authorization/new">
              ...
              <div className="col-4">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    {/* <div className="fs-4 text-dark fw-bolder">$49</div> */}
                    <Link to="/professionalclaim/service-authorization/search">
                      <div className="fs-7 fw-bolder text-danger">Search</div>
                    </Link>
                  </div>
                  {/*end::Title*/}
                </div>
              ...
              <div className="col-4">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    {/* <div className="fs-4 text-dark fw-bolder">$49</div> */}
                    <Link to="/professionalclaim/service-authorization/renewal-search">
                      <div className="fs-7 fw-bolder text-primary">Renewal Search</div>
                    </Link>
                  </div>
                  {/*end::Title*/}
                </div>
            ...
            <div className="row g-0 mt-4 col-12">
              ...
              <div className="col-6">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    ...
                    <Link to="/professionalclaim/service-authorization/applied-rate-history-search">
                      <div className="fs-7  fw-bolder text-info">Applied Rate History Search</div>
                    </Link>
                  </div>
                  {/*end::Title*/}
                </div>
              ...
              <div className="col-6">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    {/* <div className="fs-4 text-dark fw-bolder">$5.8M</div> */}
                    <Link to="/professionalclaim/service-authorization/archive">
                      <div className="fs-7  fw-bolder text-dark">Archive</div>
                    </Link>
                  </div>
                  {/*end::Title*/}
                </div>
...
export default ServiceAuthorizationCard