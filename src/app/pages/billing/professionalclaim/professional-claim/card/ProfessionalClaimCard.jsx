...
function ProfessionalClaimCard() {
  return (
    <>
      ...
      <div className="card card-stretch-75 mb-xl-8">
        ...
        <div className="card-header border-0 bg-dark py-5">
          <h3 className="card-title fw-bolder text-white">Professional Claim</h3>
        </div>
        {/*end::Header*/}
        {/*begin::Body*/}
            ...
            <div className="row g-0 ">
              ...
              <div className="col-6">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    ...
                    <Link to="/professionalclaim/professional-claim/new">
              ...
              <div className="col-6">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    {/* <div className="fs-4 text-dark fw-bolder">$49</div> */}
                    <Link to="/professionalclaim/professional-claim/new-template">
                      <div className="fs-7 fw-bolder text-success">New (Using Template)</div>
                    </Link>
                  </div>
                  {/*end::Title*/}
                </div>
            ...
            <div className="row g-0 mt-4 col-12">
              ...
              <div className="col-6">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    {/* <div className="fs-4 text-dark fw-bolder">$49</div> */}
                    <Link to="/professionalclaim/professional-claim/search">
              ...
              <div className="col-6">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    ...
                    <Link to="/professionalclaim/professional-claim/archive">
                      <div className="fs-7  fw-bolder text-info">Archive</div>
                    </Link>
                  </div>
                  {/*end::Title*/}
                </div>
...
export default ProfessionalClaimCard