        ...
        <div>
            <div className='fv-row mb-7 fv-plugins-icon-container p-5 card'>
                <div className='card-body'>
                    <h1 className='mb-5'>Professional Claim: Service Authorization Excel Upload</h1>
                    <div className='row'>
                ...
                <div className='card-body'>
                    <div className='row'>
                        <div className='col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 my-1'>
                            <Link to='#'>
                                <div><b>Download from Excel</b></div>
                            </Link>
                            <Link to='#'>
                                <div><b>Export to Excel (Existing Service Authorization)</b></div>
                            </Link>
                        </div>
                    </div>
                </div>
            ...
            <div className='d-flex flex-stack'>
                <div>
                    <Link to='/billing/professional-claim-service-authorization'>
