    ...
    <div>
      <div className='fv-row mb-7 fv-plugins-icon-container p-5 card'>
        <div className='card-body'>
          <h1 className='mb-5'>Cost Center Type</h1>
          <div className='row'>
        ...
        <div className='card-body'>
          <div className='row'>
            ...
            <div style={{ backgroundColor: "BlanchedAlmond" }} className='col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 my-3'>
              <p className='mt-3'>Once a Cost Center is used the Cost Center Name can no longer be changed.</p>
            </div>
                ...
                >
                  <thead>
                    <tr className='text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0'>
                      ...
                      <th className="min-w-200px">ID Number</th>
                      <th className="min-w-80px">Active</th>
                    </tr>
                  </thead>
