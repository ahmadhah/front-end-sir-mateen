    ...
    <>
      ...
      <div className="card card-stretch-75 mb-xl-8">
        ...
        <div className="card-header border-0 bg-primary py-5">
          <h3 className="card-title fw-bolder text-white">Shared Contact</h3>
        </div>
        {/*end::Header*/}
        {/*begin::Body*/}
              ...
              <div className="col-xxl-6 col-xl-6 col-md-12 col-sm-6 col-6 mt-1">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    ...
                    <Link to="/general/shared-contact/new">
              ...
              <div className="col-xxl-6 col-xl-6 col-md-12 col-sm-6 col-6 mt-1">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    ...
                    <Link to="/general/shared-contact/list">
                      <div className="fs-7 fw-bolder text-primary">List</div>
                    </Link>
                  </div>
                  {/*end::Title*/}
                </div>
            ...
            <div className="row g-0 mt-4 ">
                ...
                <div className="d-flex align-items-center me-2">
                  ...
                  <div className="symbol symbol-50px me-3">
                    <div className="symbol-label bg-light-danger">
                      ...
                      <KTSVG path="/media/icons/duotune/coding/cod007.svg" />
                      </span>
                      {/*end::Svg Icon*/}
                    </div>
                  </div>
                  ...
                  <div>
                    {/* <div className="fs-4 text-dark fw-bolder">$49</div> */}
                    <Link to="/general/shared-contact/link">
                      <div className="fs-7 fw-bolder text-danger">Link</div>
                    </Link>
                  </div>
                  {/*end::Title*/}
                </div>
              ...
              <div className="col-xxl-6 col-xl-6 col-md-12 col-sm-6 col-6 mt-2">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    {/* <div className="fs-4 text-dark fw-bolder">$5.8M</div> */}
                    <Link to="/general/shared-contact/import-from-excel">
                      <div className="fs-7  fw-bolder text-info">Import from Excel</div>
                    </Link>
                  </div>
                  {/*end::Title*/}
                </div>
