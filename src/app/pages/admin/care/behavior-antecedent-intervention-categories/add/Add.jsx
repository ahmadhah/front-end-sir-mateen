    ...
    <div>
      <div className='fv-row mb-7 fv-plugins-icon-container p-5 card'>
        <div className='card-body'>
          ...
          <div className='row'>
            <h3 className='mb-5 mt-5 text-primary display-7'>Behavior/Antecedent/Intervention Category Information</h3>
      ...
      <div className='fv-row mb-7 fv-plugins-icon-container p-5 card'>
        <div className='card-body'>
          <div className='row'>
            <h3 className='mb-5 text-primary display-7'>Behavior Category List</h3>
      ...
      <div className='fv-row mb-7 fv-plugins-icon-container p-5 card'>
        <div className='card-body'>
          <div className='row'>
            <h3 className='mb-5 mt-5 text-primary display-7'>Antecedent Category List</h3>
            <div className='col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 my-3'>
              <h5 className='mb-5 mt-5 text-dark'>No Antecedent Category has been added</h5>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='fv-row mb-7 fv-plugins-icon-container p-5 card'>
        <div className='card-body'>
          <div className='row'>
            <h3 className='mb-5 text-primary display-7'>Intervention Category List</h3>
            <div className='card mb-5 col-mb-10' id='kt_content'>
              <div className='post d-flex flex-column-fluid' id='kt_post'>
                <div id='kt_content_container' className='container-xxl'>
                  <div className='card'>
