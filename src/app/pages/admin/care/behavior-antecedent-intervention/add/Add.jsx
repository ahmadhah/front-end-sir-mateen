                    ...
                    <div className='row'>
                        ...
                        <div className='col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 my-3'>
                            ...
                            <select className='form-select form-select-lg mb-3' aria-label='.form-select-lg example'>
                                ...
                                <option value=''>Assualtive</option>
                                <option value=''>Attention Seeking</option>
                                <option value=''>Mental Health</option>
                                <option value=''>Non-Compliant</option>
                                <option value=''>Obsessive-Compulsive</option>
                                <option value=''>Positive Behavior</option>
                                <option value=''>Property Destruction</option>
                                <option value=''>Self Injurious</option>
                                <option value=''>Self Stimulation</option>
