...
function IndividualPlanAgendaCard() {
  return (
    <>
      <div className={`card card-stretch-100 mb-xl-8`}>
        ...
        <div className='card-body p-0'>
          {/* begin::Header */}
          <div className={`px-9 pt-7 border-0 bg-primary w-100 card-rounded-top`}>
            {/* begin::Heading */}
            <div className='d-flex  flex-stack'>
              <h3 className="card-title fw-bolder text-white">Individual Plan Agenda</h3>
            </div>
            {/* end::Heading */}
          </div>
          {/* end::Header */}
          ...
          >
              ...
              <div className='d-flex align-items-center flex-wrap w-100'>
                ...
                <div className='mb-1 pe-3 flex-grow-1'>
                  <div className='fs-5 text-gray-800 text-hover-primary fw-bolder'>
                    <Link style={{ color: "inherit" }} to="/individualplans/individual-plan-agenda/new">New</Link>
                  </div>
                </div>
                {/* end::Title */}
            ...
            <div className='d-flex align-items-center'>
              ...
              <div className='d-flex align-items-center flex-wrap w-100'>
                ...
                <div className='mb-1 pe-3 flex-grow-1'>
                  <div className='fs-5 text-gray-800 text-hover-primary fw-bolder'>
                    <Link style={{ color: "inherit" }} to="/individualplans/individual-plan-agenda/search">Search</Link>
                  </div>
                </div>
                {/* end::Title */}
...
export default IndividualPlanAgendaCard