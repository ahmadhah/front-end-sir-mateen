...
function ISPProgramTemplateLiabraryCard() {
  return (
    <>
      ...
      <div className="card card-stretch-75 mb-xl-8">
        ...
        <div className="card-header border-0 bg-primary py-5">
          <h3 className="card-title fw-bolder text-white">ISP Program Template Library</h3>
        </div>
        {/*end::Header*/}
        {/*begin::Body*/}
              ...
              <div className="col-6">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    ...
                    <Link to="/care/isp-program-template-liabrary/new">
              ...
              <div className="col-6">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div className="symbol symbol-50px me-3">
                    <div className="symbol-label bg-light-primary">
                      ...
                      <span className="svg-icon svg-icon-1 svg-icon-primary">
                        <KTSVG path="/media/icons/duotune/files/fil001.svg" />
                      </span>
                      {/*end::Svg Icon*/}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <Link to="/care/isp-program-template-liabrary/draft">
                      <div className="fs-7 fw-bolder text-primary">Draft</div>
                    </Link>
                  </div>
                  {/*end::Title*/}
                </div>
            ...
            <div className="row g-0 mt-4 col-12">
              ...
              <div className="col-6">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    {/* <div className="fs-4 text-dark fw-bolder">$49</div> */}
                    <Link to="/care/isp-program-template-liabrary/search">
              ...
              <div className="col-6">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    {/* <div className="fs-4 text-dark fw-bolder">$5.8M</div> */}
                    <Link to="/care/isp-program-template-liabrary/approved">
                      <div className="fs-7  fw-bolder text-info">Approved</div>
                    </Link>
                  </div>
                  {/*end::Title*/}
                </div>
...
export default ISPProgramTemplateLiabraryCard