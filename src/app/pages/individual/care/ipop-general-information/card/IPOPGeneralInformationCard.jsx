...
function IPOPGeneralInformationCard() {
  return (
    <>
      ...
      <div className="card card-stretch-75 mb-xl-8">
        ...
        <div className="card-header border-0 bg-info py-5">
          <h3 className="card-title fw-bolder text-white">IPOP General Information</h3>
        </div>
        {/*end::Header*/}
        {/*begin::Body*/}
              ...
              <div className="col-6">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    ...
                    <Link to="/care/ipop-general-information/new">
              ...
              <div className="col-6">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    ...
                    <Link to="/care/ipop-general-information/acknowledge">
            ...
            <div className="row g-0 mt-4 col-12">
              ...
              <div className="col-6">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    {/* <div className="fs-4 text-dark fw-bolder">$49</div> */}
                    <Link to="/care/ipop-general-information/archive">
              ...
              <div className="col-6">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    {/* <div className="fs-4 text-dark fw-bolder">$5.8M</div> */}
                    <Link to="/care/ipop-general-information/search">
...
export default IPOPGeneralInformationCard