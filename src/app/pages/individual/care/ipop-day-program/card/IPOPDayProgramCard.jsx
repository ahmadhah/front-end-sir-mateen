    ...
    <>
      ...
      <div className="card card-stretch-75 mb-xl-8">
        ...
        <div className="card-header border-0 bg-warning py-5">
          <h3 className="card-title fw-bolder text-white">IPOP Day Program </h3>
        </div>
        {/*end::Header*/}
        {/*begin::Body*/}
              ...
              <div className="col-xxl-6 col-xl-6 col-md-12 col-sm-6 col-6 mt-2">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    ...
                    <Link to="/care/ipop-day-program/new">
              ...
              <div className="col-xxl-6 col-xl-6 col-md-12 col-sm-6 col-6 mt-2">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    ...
                    <Link to="/care/ipop-day-program/acknowledge">
            ...
            <div className="row g-0 mt-4 ">
              ...
              <div className="col-xxl-6 col-xl-6 col-md-12 col-sm-6 col-6 mt-2">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    {/* <div className="fs-4 text-dark fw-bolder">$49</div> */}
                    <Link to="/care/ipop-day-program/archive">
              ...
              <div className="col-xxl-6 col-xl-6 col-md-12 col-sm-6 col-6 mt-2">
                <div className="d-flex align-items-center me-2">
                  ...
                  <div>
                    {/* <div className="fs-4 text-dark fw-bolder">$5.8M</div> */}
                    <Link to="/care/ipop-day-program/search">
...
export default IPOPDayProgramCard